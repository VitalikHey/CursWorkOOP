...
double Transaction::conductTransaction(const std::variant<Metal, Cryptocurrency, Currency> &from,
...
double Transaction::conductCurrencyTransaction(const Currency &fromCurrency, const Currency &toCurrency,
                                               const Bank &bank) const {
...
double Transaction::conductMetalTransaction(const Metal &fromMetal, const Metal &toMetal,
                                            const Bank &bank) const {
...
double
Transaction::conductCryptocurrencyTransaction(const Cryptocurrency &fromCryptocurrency,
                                              const Cryptocurrency &toCryptocurrency,
                                              const Bank &bank) const {
