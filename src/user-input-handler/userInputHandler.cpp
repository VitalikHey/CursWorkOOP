...
Bank UserInputHandler::selectBank(const std::vector<Bank> &banks) {
    while (true) {
...
std::string UserInputHandler::getSavingType() {
    while (true) {
...
Currency UserInputHandler::getCurrencyFromInputHandler(const std::vector<Currency> &currencies, const bool isFrom) {
    while (true) {
...
Metal UserInputHandler::getMetalFromInputHandler(const std::vector<Metal> &metals, const bool isFrom) {
    while (true) {
...
Cryptocurrency UserInputHandler::getCryptoCurrencyFromInputHandler(const std::vector<Cryptocurrency> &cryptocurrencies,
                                                                   const bool isFrom) {
    while (true) {
